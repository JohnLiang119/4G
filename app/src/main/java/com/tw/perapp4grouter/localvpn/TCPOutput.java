...
import com.tw.perapp4grouter.localvpn.Packet.TCPHeader;
import com.tw.perapp4grouter.localvpn.TCB.TCBStatus;
...
public class TCPOutput implements Runnable
{
            ...
            throws IOException
    {
        ...
        if (tcpHeader.isSYN())
        {
            ...
            LocalVpnNetworkHelper.bindSocketToNetwork(outputChannel.socket());
